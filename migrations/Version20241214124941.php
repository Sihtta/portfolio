 ...
 */
final class Version20241214124941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE username_history ADD CONSTRAINT FK_D8774E9EA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
    }
