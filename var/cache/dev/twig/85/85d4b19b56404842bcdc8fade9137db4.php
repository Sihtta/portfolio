...
class __TwigTemplate_79793e7581e2a9edfb3ffd91df97d044 extends Template
{
...
\t\t<a href=\"";
        ...
        yield "\" class=\"btn btn-primary\" style=\"margin-top: 20px; padding: 10px 20px; font-size: 1rem;\">
\t\t\tRetour à l'accueil
\t\t</a>
\t</div>
";
...
\t\t\tBienvenue dans l'espace d'administration de votre portfolio.
\t\t</p>
\t\t<a href=\"{{ path('home.index') }}\" class=\"btn btn-primary\" style=\"margin-top: 20px; padding: 10px 20px; font-size: 1rem;\">
\t\t\tRetour à l'accueil
\t\t</a>
\t</div>
{% endblock %}
", "admin/dashboard.html.twig", "C:\\xampp\\htdocs\\portfoliofinalfinal\\master\\templates\\admin\\dashboard.html.twig");
    }
}
