...
class __TwigTemplate_df8abfb4ceabf8a51aa7767d8ff94e34 extends Template
{
...
\t\t\t\t</li>
\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t<a class=\"nav-link\" href=\"{{ path('creation.index') }}\">Créations</a>
\t\t\t\t</li>
\t\t\t</ul>
\t\t\t<ul class=\"navbar-nav ms-auto\">
\t\t\t\t<li class=\"nav-item\">
