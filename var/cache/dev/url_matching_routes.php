...
return [
    ...
    [ // $staticRoutes
        ...
        '/base' => [[['_route' => 'base', '_controller' => 'App\\Controller\\UserController::base'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        201 => [[['_route' => 'user.edit', '_controller' => 'App\\Controller\\UserController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        234 => [
